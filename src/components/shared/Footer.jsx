      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <img
              ...
              onError={(e) => {
                ...
                e.target.parentNode.innerHTML = '<div class="footer-logo-text">Skilliacademy</div>';
              }}
            />
          ...
          <nav className="footer-nav">
            ...
            <Link to="/poei">POEI</Link>
            <Link to="/formation">Formation OPCO</Link>
          </nav>
          ...
          <div className="footer-contact">
            ...
            <a href="mailto:contact@skilliacademy.fr" className="footer-link">
              <Icons.Mail size={16} style={{ marginRight: '8px' }} /> contact@skilliacademy.fr
            </a>
        ...
        <div className="footer-bottom">
          <span>© {currentYear} Skilliacademy. Tous droits réservés.</span>
        </div>
      </div>
